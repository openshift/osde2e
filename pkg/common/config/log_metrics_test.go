...
func TestHasMatches(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			Name:  "match found",
			Regex: "no such host",
			Text: `time="2020-05-09T16:12:33Z" level=debug msg="Still waiting for the Kubernetes API: Get https://api.ci-cluster-4-3.b9t7.p2.openshiftapps.com:6443/version?timeout=32s: dial tcp: lookup api.ci-cluster-4-3.b9t7.p2.openshiftapps.com on 10.121.6.76:53: no such host"
time="2020-05-09T16:12:33Z" level=debug msg="Still waiting for the Kubernetes API: Get https://api.ci-cluster-4-3.b9t7.p2.openshiftapps.com:6443/version?timeout=32s: dial tcp: lookup api.ci-cluster-4-3.b9t7.p2.openshiftapps.com on 10.121.6.76:53: no such host"
time="2020-05-09T16:12:33Z" level=debug msg="Still waiting for the Kubernetes API: Get https://api.ci-cluster-4-3.b9t7.p2.openshiftapps.com:6443/version?timeout=32s: dial tcp: lookup api.ci-cluster-4-3.b9t7.p2.openshiftapps.com on 10.121.6.76:53: no such host"`,
			IgnoreStrings:           []string{},
