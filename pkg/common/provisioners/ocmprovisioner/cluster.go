...
func (o *OCMProvisioner) LaunchCluster() (string, error) {
	cfg := config.Instance
...
func (o *OCMProvisioner) DeleteCluster(clusterID string) error {
...
func (o *OCMProvisioner) GetCluster(clusterID string) (*spi.Cluster, error) {
...
func (o *OCMProvisioner) ClusterKubeconfig(clusterID string) ([]byte, error) {
...
func (o *OCMProvisioner) InstallAddons(clusterID string, addonIDs []string) (num int, err error) {
	num = 0
