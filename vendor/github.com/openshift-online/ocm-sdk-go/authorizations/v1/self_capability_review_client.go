...
// responses.
func NewSelfCapabilityReviewClient(transport http.RoundTripper, path string, metric string) *SelfCapabilityReviewClient {
...
// 'post' method.
func (r *SelfCapabilityReviewPostRequest) marshal(writer io.Writer) error {
	stream := helpers.NewStream(writer)
	r.stream(stream)
	return stream.Error
}
func (r *SelfCapabilityReviewPostRequest) stream(stream *jsoniter.Stream) {
}
