...
// accessReviewRequestData is the data structure used internally to marshal and unmarshal
// objects of type 'access_review_request'.
type accessReviewRequestData struct {
...
// MarshalAccessReviewRequest writes a value of the 'access_review_request' to the given target,
...
// wrap is the method used internally to convert a value of the 'access_review_request'
// value to a JSON document.
func (o *AccessReviewRequest) wrap() (data *accessReviewRequestData, err error) {
	if o == nil {
		return
	}
...
// value of the 'access_review_request' type.
func (d *accessReviewRequestData) unwrap() (object *AccessReviewRequest, err error) {
	if d == nil {
		return
	}
