...
// of type 'metric'.
type metricListData []*metricData

// UnmarshalMetricList reads a list of values of the 'metric'
...
// list of values of the 'metric' type.
func (d metricListData) unwrap() (list *MetricList, err error) {
	if d == nil {
		return
	}
	items := make([]*Metric, len(d))
	for i, item := range d {
