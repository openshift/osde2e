...
func readClustersAddRequest(request *ClustersAddServerRequest, r *http.Request) error {
	var err error
...
func writeClustersAddResponse(response *ClustersAddServerResponse, w http.ResponseWriter) error {
	return MarshalCluster(response.body, w)
}
func readClustersListRequest(request *ClustersListServerRequest, r *http.Request) error {
	var err error
	query := r.URL.Query()
