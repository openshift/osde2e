...
// of type 'sample'.
type sampleListData []*sampleData

// UnmarshalSampleList reads a list of values of the 'sample'
...
// list of values of the 'sample' type.
func (d sampleListData) unwrap() (list *SampleList, err error) {
	if d == nil {
		return
	}
	items := make([]*Sample, len(d))
	for i, item := range d {
