...
const parentURL = 'https://openshift.github.io/osde2e/';
...
function fileClosure(){ 
  ...
  (function navToggle() {
    doc.addEventListener('click', function(event){
      ...
      const harmburgerIcon = 'https://openshift.github.io/icons/bar.svg';
      const closeIcon = 'https://openshift.github.io/icons/cancel.svg';
      if(isNavToggle) {
        event.preventDefault();
